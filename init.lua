...
do
  ...
  end, { desc = '[S]earch [F]iles (all, incl. gitignored)' })
...
do
  ...
  local parsers = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'python', 'json', 'jsonc', 'yaml', 'nix' }
